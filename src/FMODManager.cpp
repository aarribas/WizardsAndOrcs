...
FMODManager::~FMODManager()
{
	std::map<std::string, FMOD::Sound*>::iterator soundIt = m_sounds.begin();
...
void FMODManager::addSound(const std::string &name, const std::string &filename)
{
...
int FMODManager::playSound(const std::string &name)
{
...
void FMODManager::removeSound(const std::string& name)
{
	std::map<std::string, FMOD::Sound*>::iterator soundIt = m_sounds.find(name);
...
FMOD::Channel *FMODManager::getChannel(int playId)
{
