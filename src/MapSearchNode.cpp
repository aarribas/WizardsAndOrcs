...
bool MapSearchNode::GetSuccessors( AStarSearch<MapSearchNode> *astarsearch, MapSearchNode *parent_node )
{
	...
	NewNode.SetMap(m_map,m_mapWidth,m_mapHeight);
	...
	//change to the original code to allow movements in a diagonal
	if( (GetMap( x-1, y-1 ) < 9)
...
void MapSearchNode::SetMap(int *map,int mapWidth, int mapHeight)
{
	m_map = map;
	m_mapWidth = mapWidth;
